...
### 方式一：在 Codex 里安装 skill

如果你的 Codex 支持从 GitHub 安装 skill，安装这个仓库：

```text
terryxming/lingxing-ad-operation-audit
```

仓库根目录就是 skill 根目录，包含 `SKILL.md`。

### 方式二：手动下载

```powershell
git clone https://github.com/terryxming/lingxing-ad-operation-audit.git
cd lingxing-ad-operation-audit
```
